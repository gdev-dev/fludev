...
import 'package:fludev/expansion_tile_wechat.dart' as expansion_tile_wechat;
import 'package:fludev/expansion_tile_wechat.dart' show Entry;

void main() {
  testWidgets('expansion_tile wechat smoke test', (WidgetTester tester) async {
    expansion_tile_wechat.main();
    await tester.pump();

    // Initially only the top level EntryItems (the "chapters") are present.
    for (Entry chapter in expansion_tile_wechat.data) {
    ...
    for (Entry chapter in expansion_tile_wechat.data.reversed)
